...
import byow.Core.EventUI;
import byow.Core.HUD;
import byow.Core.Mouse;
...
public class TERenderer {
     ...
     */
    public void initialize(int w, int h, int xOff, int yOff, EventUI eventUI) {
        this.width = w;
        this.height = h;
        this.xOffset = xOff;
        this.yOffset = yOff;
     ...
     * @param h height of the window in tiles.
     */
    public void initialize(int w, int h, EventUI eventUI) {
        initialize(w, h, 0, 0, eventUI);
    }
     ...
     */
    public void renderFrame(TETile[][] world, boolean eventTriggered, boolean gameOver) {
        resetFont();
        int numXTiles = world.length;
        int numYTiles = world[0].length;
        this.inEvent = eventTriggered;
        StdDraw.enableDoubleBuffering();
        StdDraw.picture(35, 20, "background.gif", 70, 40);
    ...
    public void setHud(int width, int height, Player player, Mouse mouse, TETile[][] worldArray) {
        this.hud = new HUD(width, height, player, mouse, worldArray);
    }
}
